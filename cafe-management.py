...
"""
Program: Java Co Online Ordering Program
Author: Krissy Brown
Date: 3/1/2023
...
class cafe_management():
        ...
        def __init__(self):
                ...
                self.root.title("Java Co ordering System")
                self.root.maxsize(500,300)
                self.root.minsize(500,300)
                self.root['bg'] = "white"

                self.heading = Label(self.root,text="Java Co ordering System",font=('verdana',20,'bold'),fg="#248aa2",bg="white")
                ...
                self.cafe_icon = ImageTk.PhotoImage(Image.open('coffee.png'))
                ...
                self.sandwitch = Label(self.frame1,text="Sandwich",font=('verdana',10,'bold'),bg="white")
